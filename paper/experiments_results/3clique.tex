...
\begin{multicols}{2}
	\begin{figure}
		\centering
		\includegraphics[width=0.37\textwidth]{3clique_before_merge_example.png}
		\captionof{figure}{3-clique before merge}
	\end{figure}

	\begin{figure}
		\centering
		\includegraphics[width=0.2\textwidth]{3clique_merged_example.png}
